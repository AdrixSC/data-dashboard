...
document.getElementById("informationStudentArequipa").innerHTML = data.AQP['2016-2'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
    ...
    return res + `
  <div class='item'>
      <img class='image' src="${act.photo}">
      <div class='textItem'>
        <span><strong> Nombre:</strong> ${act.name}</span>
        <span><strong> Status:</strong> ${textActive}</span>
      </div>
   </div>
  `;
...
document.getElementById("informationStudentArequipa1").innerHTML = data.AQP['2017-1'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
...
document.getElementById("informationStudentCdmx").innerHTML = data.CDMX['2017-1'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
...
document.getElementById("informationStudentCdmx2").innerHTML = data.CDMX['2017-2'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
...
document.getElementById("informationStudentLim").innerHTML = data.LIM['2016-2'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
...
document.getElementById("informationStudentLim1").innerHTML = data.LIM['2017-1'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
...
document.getElementById("informationStudentLim2").innerHTML = data.LIM['2017-2'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
...
document.getElementById("informationStudentScl").innerHTML = data.SCL['2016-2'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
...
document.getElementById("informationStudentScl1").innerHTML = data.SCL['2017-1'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
...
document.getElementById("informationStudentScl2").innerHTML = data.SCL['2017-2'].students.reduce(function(res, act) {
    var textActive = '';
    if (act.active) {
        textActive = 'activo';
    } else {
